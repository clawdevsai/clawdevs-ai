...
Em produção: integrar OpenCode para planejamento e implementação.
Ref: docs/issues/013-pods-tecnicos-developer-opencode.md
"""
import os
import sys
import time
...
def process_task(r, stream: str, msg_id: str, data: dict) -> None:
    """Processa uma tarefa: adquire GPU Lock, executa (stub ou Ollama), libera."""
