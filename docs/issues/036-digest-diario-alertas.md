...
- [ ] Implementação: script ou job (ex.: CronJob no cluster) que agrega eventos do dia e publica digest; gateway ou adaptador que envia alertas imediatos conforme regras acima.
