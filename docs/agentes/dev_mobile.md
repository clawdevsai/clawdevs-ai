...
- Agendador de fila (issues `mobile`).
- Implementar TASK (app mobile); vibe coding; SDD.
- Testes unit/e2e; pipeline loja (EAS/Fastlane); CI/CD; GitHub; status; loop com QA.

**Papel:** apps mobile (padrão React Native/Expo; Flutter só com ADR).

**Faz:**
- Fila GitHub: label **`mobile`**.
