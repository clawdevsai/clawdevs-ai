...
- Agendador de fila (issues `front_end`).
- Implementar TASK (UI web); vibe coding; SDD; Spec Kit.
- Testes (unit/e2e, CWV); Storybook/isolamento de componentes.
- CI/CD (lint, build, a11y); GitHub; status; loop com QA (falhas).

**Papel:** UI web (React/Next/Vue/TS, etc.) com acessibilidade e performance.

**Faz:**
- Fila GitHub: label **`front_end`**.
