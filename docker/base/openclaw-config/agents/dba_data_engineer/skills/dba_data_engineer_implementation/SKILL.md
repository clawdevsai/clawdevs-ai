...
This skill recommends database architectures and data engineering patterns. It analyzes data requirements across volume, velocity, variety, and consistency needs. The system provides guidance on data modeling, schema design, indexing strategies, ETL processes, and performance optimization.
