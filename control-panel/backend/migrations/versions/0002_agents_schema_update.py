...
def upgrade() -> None:
    ...
    op.add_column('agents', sa.Column('openclaw_session_id', sa.String(), nullable=True))
...
def downgrade() -> None:
    op.add_column('agents', sa.Column('heartbeat_count', sa.Integer(), nullable=False, server_default='0'))
